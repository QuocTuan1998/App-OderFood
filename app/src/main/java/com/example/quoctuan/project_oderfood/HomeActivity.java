...
import com.example.quoctuan.project_oderfood.model.Category;
import com.example.quoctuan.project_oderfood.viewholder.MenuViewHolder;
...
//        Init Firebase
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent cardIntent = new Intent(HomeActivity.this,CartActivity.class);
...
//        Load Menu
    ...
    private void loadMenu() {
        adapter = new FirebaseRecyclerAdapter<Category,
                MenuViewHolder>(Category.class,R.layout.menu_item,
